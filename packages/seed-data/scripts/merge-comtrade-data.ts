...
// 파일 경로
const exportPath = join(__dirname, '..', `raw-export-${PERIOD}.json`);
const importPath = join(__dirname, '..', `raw-import-${PERIOD}.json`);
const outputPath = join(__dirname, '..', 'comtrade-api-response.json');
