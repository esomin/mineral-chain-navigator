...
const PERIOD = '2025';
const REPORTER_CODES = '36,152,32,156'; // 수출국: 호주(36), 칠레(152), 아르헨티나(32), 중국(156)
const PARTNER_CODES = '410,616,156';    // 수입국: 한국(410), 폴란드(616), 중국(156)

export const OUTPUT_PATH = join(__dirname, '..', '..', 'data', 'raw', 'comtrade', `raw-export-${PERIOD}.json`);
