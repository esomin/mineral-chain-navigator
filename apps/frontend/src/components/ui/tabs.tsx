...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={cn(
      "mt-2 ring-offset-background focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 flex-1 min-h-0 flex flex-col data-[state=inactive]:hidden",
      className
    )}
    {...props}
  />
